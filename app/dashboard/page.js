...
import { Btn, Card, MoneyDisplay } from "@/components/UI";
        ...
        {hasSavingsGoal && (
          <>
            ...
            >
              ...
              <MoneyDisplay value={savingsGoal} color="var(--accent-text)" size="hero" />
              <div className="mt-6 pt-4" style={{ borderTop: "1px solid var(--border-subtle)" }}>
                <p className="text-sm" style={{ color: "var(--text-tertiary)" }}>In 12 months, you'll save</p>
                <div className="mt-1">
                  <MoneyDisplay value={baselineYearly} size="large" />
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="min-w-0">
                  <p className="text-xs uppercase tracking-widest mb-1" style={{ color: "var(--text-tertiary)" }}>New monthly</p>
                  <MoneyDisplay value={newMonthly} size="medium" />
                </div>
                <div className="min-w-0">
                  <p className="text-xs uppercase tracking-widest mb-1" style={{ color: "var(--text-tertiary)" }}>In 12 months</p>
                  <MoneyDisplay value={yearlyProjection} size="medium" color="var(--accent-text)" />
                </div>
              </div>
